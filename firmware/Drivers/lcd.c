/***
   ...
   *  @description
	*
	* + 1.54��Һ��ģ�飨�ͺţ�SPI154M1-240*240��
	* 
	*¹С��
	*
>>>>> ��Ҫ˵����
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
   ...
   if(hspi->Instance==SPI6)
   {
		...
		__HAL_RCC_SPI6_CLK_ENABLE();			// ʹ��SPI6ʱ��

		__HAL_RCC_GPIOG_CLK_ENABLE();		// ʹ�� SPI6 GPIO
		
      GPIO_LDC_Backlight_CLK_ENABLE;   // ʹ�� ����        ����ʱ��
      GPIO_LDC_DC_CLK_ENABLE;          // ʹ�� ����ָ��ѡ�� ����ʱ��

/******************************************************  
		PE11     ------> SPI6_NSS��ʹ��Ӳ��Ƭѡ
		PE12     ------> SPI6_SCK
		PE14     ------> SPI6_MOSI
...
// ��ʼ�� SCK��MOSI�Լ�Ƭѡ���ţ�ʹ��Ӳ�� SPI Ƭѡ
      GPIO_InitStruct.Pin 		   = GPIO_PIN_8|GPIO_PIN_13|GPIO_PIN_14; // SCK��MOSI�Լ�Ƭѡ����
      GPIO_InitStruct.Mode 		= GPIO_MODE_AF_PP;            			// �����������
      GPIO_InitStruct.Pull 		= GPIO_NOPULL;                			// ��������
      GPIO_InitStruct.Speed 		= GPIO_SPEED_FREQ_VERY_HIGH;  			// ����ٶȵȼ�
      GPIO_InitStruct.Alternate  = GPIO_AF5_SPI6;              			// ���õ�SPI6��������1
...
// SPI���ں�ʱ������Ϊ120M���پ���2��Ƶ�õ� 60M ��SCK����ʱ��
...
*					3. �����ö�Ӧ�ı���ɫ������ʹ�� LCD_SetBackColor(0x000000) ����Ϊ��ɫ�ı���ɫ
*					4. ʹ��ʾ�� LCD_DisplayString( 10, 10, "¹С��") ������ʼ����Ϊ(10,10)�ĵط���ʾ�ַ���"¹С��"
*
*****************************************************************************************************************************************/
